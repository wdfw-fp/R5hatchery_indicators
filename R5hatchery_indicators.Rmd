...
fgdb <- "data/WCR_Salmon_Steelhead_gdb_2015.gdb"
if (file.exists(fgdb)) {
  ...
  writeBin(content, "data/WCR_Salmon_Steelhead_gdb_2015.zip")
  #download.file(, destfile = "data/WCR_Salmon_Steelhead_gdb_2015.zip", mode = "wb",timeout = 300)
  unzip("data/WCR_Salmon_Steelhead_gdb_2015.zip", exdir = "data")
}
